          ...
          <Grid.Row>
            <Form>
              <Form.Group widths="equal">
                <Form.Field>
                  <Dropdown placeholder="Selecione um país" fluid selection search={true} name="countryCode" value={countryCode} clearable={true} onChange={handleForm} options={countriesOptions} />
                </Form.Field>
              </Form.Group>
            </Form>
          </Grid.Row>
